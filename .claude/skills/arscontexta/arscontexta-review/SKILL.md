...
2. **`arscontexta/ops/config.yaml`** — processing depth, verification settings
...
The queue path uses the domain-native operations folder. Check `arscontexta/ops/` or equivalent.
