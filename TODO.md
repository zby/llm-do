...
- [ ] **Dynamic sandbox expansion**: Runtime approval to expand sandbox boundaries
  - See [dynamic-sandbox-expansion.md](docs/specs/dynamic-sandbox-expansion.md) for design
...
- [x] ~~**OS-level sandbox**~~: Decided against built-in OS sandbox - recommend Docker for isolation
  - See [dynamic-sandbox-expansion.md](docs/specs/dynamic-sandbox-expansion.md) for rationale
