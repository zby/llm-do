...
- Claude Code with the arscontexta skills installed in `.claude/skills/` and `arscontexta/skills/`
- The arscontexta/ops/ directory with config.yaml and derivation-manifest.md
- The arscontexta/self/ directory with identity.md, methodology.md, goals.md
- The arscontexta/templates/ directory with note.md, adr.md, index.md, observation.md
...
1. **Read arscontexta/self/** -- `arscontexta/self/identity.md`, `arscontexta/self/methodology.md`, `arscontexta/self/goals.md`. These tell you who you are, how you work, and what you are currently working on.
2. **Check arscontexta/ops/reminders.md** -- Surface any overdue time-bound commitments.
...
3. Update arscontexta/self/goals.md with current state
...
1. Drop the file in `arscontexta/inbox/`
2. `/arscontexta-seed arscontexta/inbox/source-file.md` -- queues it for processing
3. `/arscontexta-extract arscontexta/inbox/source-file.md` -- extracts insights as note candidates
4. Approve the extraction, then run `/arscontexta-connect`, `/arscontexta-revisit`, `/arscontexta-review` on each note

### Option B: Automated

```
/arscontexta-pipeline arscontexta/inbox/source-file.md
```
...
```
/arscontexta-seed arscontexta/inbox/source-file.md
/arscontexta-ralph 5
```
...
The processing queue lives at `arscontexta/ops/queue/queue.json`. Each entry tracks a single note through its lifecycle:
...
- [[configuration]] -- How to tune the system via arscontexta/ops/config.yaml
