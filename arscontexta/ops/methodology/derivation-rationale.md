...
- **Agent memory** (arscontexta/self/): new, at project root
- **Operations** (arscontexta/ops/): new, at project root
...
The existing tasks/ system (README.md, templates/, active/backlog/completed/recurring) is preserved as-is. The knowledge system's processing queue (arscontexta/ops/queue/) is separate — it handles knowledge processing tasks, not project tasks.
