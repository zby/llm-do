...
Browse notes: `ls arscontexta/ops/methodology/`
Query by category: `rg '^category:' arscontexta/ops/methodology/`
Find active directives: `rg '^status: active' arscontexta/ops/methodology/`
