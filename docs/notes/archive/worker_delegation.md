...
For design philosophy, see [`theory.md`](../../theory.md). For architecture details, see [`architecture.md`](../../architecture.md). For examples, see [`../examples/pitchdeck_eval/`](../examples/pitchdeck_eval/).
