...
The stabilise/soften cycle described in [agentic systems interpret fuzzy specifications](../../docs/theory.md) is, viewed through Simon's definition, a learning cycle. Each stabilisation step makes the system more capable for the specific case it handles. Each softening step makes it more capable for the general case. The cycle isn't maintenance — it's how the system learns.
