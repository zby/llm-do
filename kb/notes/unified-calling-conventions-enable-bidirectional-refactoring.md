...
Relevant Notes:
- [interpreting fuzzy specifications](../../docs/theory.md) — foundation: the fuzzy specifications framing that this note makes architecturally concrete
