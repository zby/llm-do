...
| Automation | Full | Claude Code platform; user confirmed self/ and ops/ placement | HIGH |
...
| self/ space | project memory | space |
...
- [x] self-space — included: self/ confirmed at project root
...
- Folder names: docs/notes/ (existing), docs/adr/ (existing), tasks/ (existing), self/ (new), ops/ (new), inbox/ (new), templates/ (new), manual/ (new)
