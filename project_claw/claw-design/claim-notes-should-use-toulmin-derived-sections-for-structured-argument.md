...
- [stabilisation-is-learning](../notes/agentic-systems-learn-through-three-distinct-mechanisms.md) — foundation: the note → structured-claim promotion path is the crystallisation gradient applied to the type system
