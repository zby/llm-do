...
- [Automating KB learning is an open problem](./automating-kb-learning-is-an-open-problem.md) *(note)* — The KB already learns through manual work; the open problem is automating the judgment-heavy mutations which require oracles we can't yet manufacture
