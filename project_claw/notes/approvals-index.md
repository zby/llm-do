...
- [pydanticai-traits-is-better-long-term-architecture-than-deferred-tool-handler](./pydanticai-traits-is-better-long-term-architecture-than-deferred-tool-handler.md) — analysis of the Traits API proposal: one of the two paths to eliminating wrapping, plus potential CallScope replacement
