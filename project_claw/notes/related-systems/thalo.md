...
- [crystallisation-learning-timescales](../crystallisation-learning-timescales.md) — contrasts: Thalo has no verifiability gradient; their rules are fixed at design time, while the verifiability gradient explains why progressive formalization (prompt -> schema -> code) beats upfront commitment
