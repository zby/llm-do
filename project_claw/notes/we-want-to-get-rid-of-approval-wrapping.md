...
**Status:** The Traits API is in research/design phase. See [pydanticai-traits-is-better-long-term-architecture-than-deferred-tool-handler](./pydanticai-traits-is-better-long-term-architecture-than-deferred-tool-handler.md) for our analysis of the proposal and its implications for llm-do.
...
- [pydanticai-traits-is-better-long-term-architecture-than-deferred-tool-handler](./pydanticai-traits-is-better-long-term-architecture-than-deferred-tool-handler.md) — analysis of the Traits API proposal and its implications for approval wrapping and lifecycle scaffolding
