...
## Goal
Run the simplification prompt on `llm_do/runtime/registry.py` and its local imports, producing a review report with proposed simplifications.

## Context
- Relevant files/symbols:
  - `llm_do/runtime/registry.py` (primary target)
  - Local imports from this repo (discovery.py, loader.py, etc.)
- Output:
