...
## Goal
Run the simplification prompt on `llm_do/ui/app.py` and its local imports, producing a review report with proposed simplifications.

## Context
- Relevant files/symbols:
  - `llm_do/ui/app.py` (primary target)
  - Local imports from this repo (events.py, display.py, widgets/, controllers/, etc.)
- Output:
...
## Tasks
- [ ] Read app.py and identify its local imports
- [ ] Analyze with the simplification prompt above
- [ ] Write review report to `docs/notes/reviews/simplify-ui-app.md`

## Current State
Not started.

## Notes
- App is the main TUI application; simplifications improve UI maintainability and reduce widget complexity
