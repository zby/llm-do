...
## Goal
Run the simplification prompt on `llm_do/cli/main.py` and its local imports, producing a review report with proposed simplifications.

## Context
- Relevant files/symbols:
  - `llm_do/cli/main.py` (primary target)
  - Local imports from this repo (config.py, models.py, etc.)
- Output:
...
## Tasks
- [ ] Read main.py and identify its local imports
- [ ] Analyze with the simplification prompt above
- [ ] Write review report to `docs/notes/reviews/simplify-cli-main.md`

## Current State
Not started.

## Notes
- Main CLI entry point; simplifications improve the developer experience and reduce CLI complexity
