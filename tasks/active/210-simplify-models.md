...
## Goal
Run the simplification prompt on `llm_do/models.py` and its local imports, producing a review report with proposed simplifications.

## Context
- Relevant files/symbols:
  - `llm_do/models.py` (primary target)
  - Local imports from this repo
- Output:
  - `docs/notes/reviews/simplify-models.md`
...
## Tasks
- [ ] Read models.py and identify its local imports
- [ ] Analyze with the simplification prompt above
- [ ] Write review report to `docs/notes/reviews/simplify-models.md`

## Current State
Not started.

## Notes
- Models module defines LLM model selection and compatibility; simplifications clarify model resolution logic
