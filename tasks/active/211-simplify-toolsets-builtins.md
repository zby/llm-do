...
## Goal
Run the simplification prompt on `llm_do/toolsets/builtins.py` and its local imports, producing a review report with proposed simplifications.

## Context
- Relevant files/symbols:
  - `llm_do/toolsets/builtins.py` (primary target)
  - Local imports from this repo (filesystem.py, shell/, approval.py, etc.)
- Output:
  - `docs/notes/reviews/simplify-toolsets-builtins.md`
...
## Tasks
- [ ] Read builtins.py and identify its local imports
- [ ] Analyze with the simplification prompt above
- [ ] Write review report to `docs/notes/reviews/simplify-toolsets-builtins.md`

## Current State
Not started.

## Notes
- Builtins defines the core builtin toolsets; simplifications improve toolset consistency and reduce boilerplate
