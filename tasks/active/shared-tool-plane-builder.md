...
## Tasks
- [ ] Create a shared builder (async context manager or helper) that instantiates toolsets, wraps approvals, and guarantees cleanup.
...
## Current State
Task updated for post-v1 cleanup; ready for implementation.
