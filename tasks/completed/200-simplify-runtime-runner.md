...
## Goal
Run the simplification prompt on `llm_do/runtime/runner.py` and its local imports, producing a review report with proposed simplifications.

## Context
- Relevant files/symbols:
  - `llm_do/runtime/runner.py` (primary target)
  - Local imports from this repo (deps.py, contracts.py, events.py, etc.)
- Output:
